        ...
        <view class="list-cell" hover-class="uni-list-cell-hover" @click="bindClick">
            <view class="media-list" v-if="data.title">
                ...
                <view class="media-foot">
                    <view class="media-info m-row m-flex-item">
                        <text class="info-text">{{data.author}}</text>
                        <text class="info-text m-flex-item">{{data.count}} 浏览</text>
                        <view class="info-text">{{data.time}}</view>
                    </view>
